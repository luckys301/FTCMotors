...
public class SlowDriveForwardCommand extends CommandBase{
    ...
    public SlowDriveForwardCommand(MecDriveSubsystem drive, double distance) {
        this.drive = drive;
    ...
    public SlowDriveForwardCommand(MecDriveSubsystem drive, double distance, MinVelocityConstraint constraint) {
        this.drive = drive;
        this.distance = distance;
