...
public class KindaSlowDriveForwardCommand extends CommandBase{
    ...
    public KindaSlowDriveForwardCommand(MecDrivetrainSubsystem drive, double distance) {
        this.drive = drive;
    ...
    public KindaSlowDriveForwardCommand(MecDrivetrainSubsystem drive, double distance, MinVelocityConstraint constraint) {
        this.drive = drive;
        this.distance = distance;
