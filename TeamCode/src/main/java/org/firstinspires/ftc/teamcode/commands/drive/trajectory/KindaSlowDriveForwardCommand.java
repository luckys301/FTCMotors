...
public class KindaSlowDriveForwardCommand extends CommandBase{
    ...
    public KindaSlowDriveForwardCommand(MecDriveSubsystem drive, double distance) {
        this.drive = drive;
    ...
    public KindaSlowDriveForwardCommand(MecDriveSubsystem drive, double distance, MinVelocityConstraint constraint) {
        this.drive = drive;
        this.distance = distance;
