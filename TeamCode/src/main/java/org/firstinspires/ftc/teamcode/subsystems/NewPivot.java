...
//        INTAKE_FRONT(INTAKE_BACK.pivotPos.get()), FRONT, HIGH_FRONT, GROUND_FRONT, DROP_FRONT,
//
//        AUTO_INTAKE_BACK(-275), AUTO_BACK(-233), AUTO_HIGH_BACK(-150), AUTO_DROP_BACK(-390),
//        AUTO_INTAKE_FRONT, AUTO_FRONT, AUTO_HIGH_FRONT,AUTO_DROP_FRONT,
////        public double ArmPos(int rt){
////            int fsr =rt;
////        }
//
//        public final double pivotPos;
//        ArmPos(double pivotPos) {
...
//
//    public NewPivot(Telemetry tl, HardwareMap hw) {
